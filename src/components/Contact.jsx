...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm(
                process.env.NEXT_PUBLIC_EMAILJS_SERVICE_ID || "service_phyrw2g",
                process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_ID || "template_pgvv64r",
                formRef.current,
                {
                    publicKey: process.env.NEXT_PUBLIC_EMAILJS_PUBLIC_KEY || '8Vxj2tq6srygft85z',
                }
            )
            .then(
                () => {
