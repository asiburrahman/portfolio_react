...
const Navbar = () => (
  <motion.div
    ...
    className="sticky top-0 z-50 shadow-xl font-bold bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500"
  >
    <div className="navbar w-11/12 mx-auto">
      <div className="navbar-start">
        ...
        <div className="flex items-center justify-center gap-2">
          <button onClick={() => scrollToSection("hero")} className="text-sm font-bold md:text-2xl lg:text-3xl">
            <img className="w-12 h-12 rounded-full md:inline-block" src="/logo.jpg" alt="Logo" />
          </button>
        </div>
      </div>
